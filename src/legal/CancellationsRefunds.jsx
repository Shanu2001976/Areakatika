        ...
        <Container className="legal-container section-padding mt-5">
            ...
            >
                <div className='page-wrapper'>
                    <h1 className="legal-title">Cancellations and Refunds</h1>
                    <div className="legal-card">
                        <div className="legal-content">
                            <p>
                                AREKATIKA MEAT UDYOG LIMITED believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:
                            </p>
                            <ul className="legal-list">
                                ...
                                <li>AREKATIKA MEAT UDYOG LIMITED does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.</li>
                                ...
                                <li>In case of any Refunds approved by the AREKATIKA MEAT UDYOG LIMITED, it’ll take 3-5 days for the refund to be processed to the end customer.</li>
                            </ul>
                        </div>
                    </div>
                </div>
